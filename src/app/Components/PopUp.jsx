      ...
      <div className="relative w-auto my-6 mx-auto max-w-3xl">
        ...
        outline-none focus:outline-none">
          ...
          <div className="flex items-start justify-between p-5 border-b border-solid border-slate-200 rounded-t">
            ...
            <button 
             className="p-1 ml-auto bg-transparent border-0 text-black opacity-5 float-right text-3xl 
              ...
              >
                <span className="bg-transparent text-black opacity-5 h-6 w-6 text2xl block outline-none
                focus:outline-none">
                  X
                </span>
              </button>
          ...
          <div className="flex items-center justify-end p-6 border-t border-solid border-slate-200 rounded-b">
            <button 
            className="text-red-500 background-transparent font-bold px-6 py-2 text-sm outline-none focus:outline-none 
