  ...
  <div className="relative bg-opacity-75 backgroundMain">
    ...
    <div className="relative px-4 py-16 mx-auto overflow-hidden sm:max-w-xl
     md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      <div className="flex flex-col items-ccenter justify-between xl:flex-row">
        <div className="w-full max-w-xl md-12 xl:mb-0 xl:pr-16 xl:w-7/12">
          ...
          text-white sm:text-5xl sm:leading-none">
            ...
            transition-colors duration-200 text-teal-accent-400 hover:text-teal-700 text-gray-200"
            >Learn More
            <Arrow />
            </a>
        </div>
          ...
          <div className="bg-white rounded shadow-2xl p-7 sm:p-10">
            ...
            <form>
              ...
              <div className="mb-1 sm:mb-2">
                ...
                className="inline-block mmb-1 font-medium">
                  Decription
                </label>
                <input 
                onChange={(e) => setCampaign({
              ...
              <button
              onClick={(e) =>creatNewCapaingn()}
              type="submit"
              className="inline-flex items-center justify-center w-full h-12 px-6 font-medium tracking-wider
              transition duration-200 rounded shadow-md bg-deep-purple-accent-400 hover:bg-deep-purple-accent-700
              focus:shadow-outline focus:outline-none text-white newColor"
              >
                Create Campaign
              </button>
                </div>
